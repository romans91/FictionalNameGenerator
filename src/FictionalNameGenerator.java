...
public class FictionalNameGenerator {
    ...
    public final static String SYLLABLES_FROM_WEBSITE_FILENAME = "SyllablesFromDictionary.csv";

    // A syllable from this file has a variable chance to be used instead of a syllable from SyllablesFromDictionary.csv
    // This file is optional
    public final static String SYLLABLES_OCCASIONAL_FILENAME = "SyllablesOccasional.csv";

    // One random syllable from this file will always appear in the output word
    // This file is optional
    public final static String SYLLABLES_MANDATORY_FILENAME = "SyllablesMandatory.csv";



    private static List<String> getSyllablesFromCsv(String filename) throws IOException {
    ...
    public static List<String> generateNames(int numberOfWords, int minSyllables, int maxSyllables, float occasionalSyllableFrequency) throws IOException {
        File syllableStore = new File(SYLLABLES_FROM_WEBSITE_FILENAME);
        ...
        for (int i = 0; i < numberOfWords; i++) {
            ...
            wordsOut.add(word.substring(0, 1).toUpperCase() + word.substring(1, word.length()));
        }
        return wordsOut;
    }
}
